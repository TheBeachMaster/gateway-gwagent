 ...
 */
- (NSString*)retrieveManifestFileUsingSessionId:(int) sessionId status:(QStatus&) status;
 ...
 */
- (AJGWCGatewayCtrlManifestRules*)retrieveManifestRulesUsingSessionId:(int) sessionId status:(QStatus&) status;
 ...
 */
- (AJGWCGatewayCtrlAccessRules*)retrieveConfigurableRulesUsingSessionId:(int) sessionId status:(QStatus&) status announcements:(NSArray*) announcements;
 ...
 */
- (AJGWCGatewayCtrlTPApplicationStatus*)retrieveStatusUsingSessionId:(int) sessionId status:(QStatus&) status;
 ...
 */
- (AJGWCRestartStatus)restartUsingSessionId:(int) sessionId status:(QStatus&) status;
 ...
 */
- (AJGWCGatewayCtrlAclWriteResponse*)createAclUsingSessionId:(int) sessionId name:(NSString*) name accessRules:(AJGWCGatewayCtrlAccessRules*) accessRules status:(QStatus&) status;
 ...
 */
- (NSArray*)retrieveAclsUsingSessionId:(int) sessionId status:(QStatus&) status;
 ...
 */
- (AJGWCAclResponseCode)deleteAclUsingSessionId:(int) sessionId aclId:(NSString*) aclId status:(QStatus&) status;
