...
#import "alljoyn/gateway/GatewayCtrlRuleObjectDescription.h"

@interface AJGWCGatewayCtrlRuleObjectDescription : NSObject

/**
 * Constructor
 * @param handle A handle to a cpp GatewayCtrlRuleObjectDescription object
 */
...
/**
 * Constructor
 * @param objectPath AllJoyn object identification {@link AJGWCGatewayCtrlRuleObjectPath}
 * @param interfaces Set of the interfaces related to the given object path
 * @param isConfigured Set TRUE to permit this {@link AJGWCGatewayCtrlRuleObjectDescription} object path and interfaces
 ...
 * @return Set of the {@link AJGWCGatewayCtrlRuleInterface} objects
 */
- (NSSet*)interfaces;

/**
 * The flag has TRUE if this {@link AJGWCGatewayCtrlRuleObjectDescription} is configured
...
/**
 * Set TRUE to permit this {@link AJGWCGatewayCtrlRuleObjectDescription} object path and interfaces
 * to be remoted by the Connector App
 ...
 * @return {@link ajn::gwcontroller::GatewayCtrlRuleObjectDescription*}
 */
