...
#import "alljoyn/gateway/GatewayCtrlAccessRules.h"
#import "AJGWCGatewayCtrlManifestRules.h"

@interface AJGWCGatewayCtrlAccessRules : NSObject

/**
 * Constructor
 * @param handle A handle to a cpp GatewayCtrlAccessRules object
 */
