...
@interface AJGWCGatewayCtrlRuleInterface : NSObject <NSCopying>

/**
 * Constructor
 * @param handle A handle to a cpp GatewayCtrlRuleInterface object
 */
 ...
 * @return GatewayCtrlRuleInterface
 */
