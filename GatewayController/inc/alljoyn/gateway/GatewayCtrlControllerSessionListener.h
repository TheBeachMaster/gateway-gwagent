...
#ifndef GatewayCtrlControllerSessionListener_H
#define GatewayCtrlControllerSessionListener_H
 ...
 *  long running tasks.
 */
class GatewayCtrlControllerSessionListener {
  public:

    /**
     * Constructor for GatewayCtrlControllerSessionListener
     */
    GatewayCtrlControllerSessionListener() { };

    /**
     * Destructor for GatewayCtrlControllerSessionListener
     */
    virtual ~GatewayCtrlControllerSessionListener() { };
...
#endif /* defined(GatewayCtrlControllerSessionListener_H) */
