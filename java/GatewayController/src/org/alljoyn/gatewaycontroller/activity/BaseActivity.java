...
public abstract class BaseActivity extends Activity {
	...
	/**
	 * Returns sessionId from the application. 
	 * If sessionId is null calls join session 
	 * @return Currently established session or NULL session 
	 * is not established. Join session is called, need to wait for receiving 
	 * {@link BaseActivity#onSessionJoined()} or {@link BaseActivity#onSessionJoinFailed()} events
	 */
	...
	/**
	 * Override this method to be notified about changes in the list of gateways. <br><br>
	 * By default this method retrieves the list of the found gateways
	 * If currently selected gateway is not in the list of the retrieved gateways 
	...
	/**
	 * Show {@link AlertDialog} with the positive button and the given title and message.
	 * @param title {@link AlertDialog} title
	 * @param message {@link AlertDialog} message
	 * @param clickListener The listener to be called 
	 */
	...
	private void showPasswordDialog() {
		...
		if ( passwordDialog == null ) {
			...
			//Define button label. The button is disabled when no text is entered 
