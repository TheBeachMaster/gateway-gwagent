...
/**
 * This fragment includes the name of the exposed services or a {@link RemotedApp}
 * and the rules for their configuration. 
 */
public class AclManagementConfDataFragment extends Fragment implements OnCheckedChangeListener {

	/**
	 * Fragment arguments key to pass the name of the item that has been selected to be configured
	 */
	 ...
	 * @param configItem The item to be presented in this fragment
