...
public class Gateway extends DiscoveredApp {
	...
	/**
	 * Constructor
	 * @param gwBusName The name of the {@link BusAttachment} of the gateway
	...
	/**
	 * Constructor
	 * @param gwBusName The name of the {@link BusAttachment} of the gateway that sent
	 * the Announcement
	 * @param aboutData The data sent with the Announcement
	 * @throws IllegalArgumentException is thrown if bad gwBusName has been received 
	 */
	...
	public List<ConnectorApplication> retrieveInstalledApps(int sessionId) throws GatewayControllerException {
		...
		ProxyBusObject proxy    = bus.getProxyBusObject( getBusName(),
													     "/gw",
												         sessionId, 
