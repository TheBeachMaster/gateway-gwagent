...
public class CommunicationUtil {
	...
	public static class SessionResult {
		...
		/**
		 * Constructor
		 * @param status Status of joining the session
		...
		/**
		 * @return Session id after joining the session.
		 * Join session status should be checked before using the session id  
		 */
		public int getSid() {
			return sid;
		}
	...
	/**
	 * Synchronously join session with the given busName. Use the given listener to notify about session
	 * related events
	 * @param bus {@link BusAttachment} to use to join session
	...
	/**
	 * Asynchronously join session with the given busName. Use the given listener to notify about session
	 * related events
	 * @param bus {@link BusAttachment} to use to join session
	 * @param busName Connect to this bus name
	 * @param listener
	...
	public static void joinSessionAsync(BusAttachment bus, String busName, ControllerSessionListener listener) {
	    ...
	    Status  status = bus.joinSession(busName, 
								         ...
								         getSessionOpts(), 
								         listener,
									     new ControllerOnJoinSessionListener(),
									     listener);
	...
	/**
	 * Returns enum constant of the given enumToSearch class, if this enumToSearch
	 * has a field of CODE that its value equals to the checkedValue.
	 * @param enumToSearch The class object of the enum to search the checkedValue.
	 * @param checkedValue The value to be searched
