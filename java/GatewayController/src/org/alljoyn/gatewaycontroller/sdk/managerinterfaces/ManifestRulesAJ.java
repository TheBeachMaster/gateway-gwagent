...
public class ManifestRulesAJ {
	...
	/**
	 * The interfaces that the Service Provider Application exposes to its clients
	 */
	@Position(0)
	public ManifestObjectDescriptionInfoAJ[] exposedServices;
	
	/**
	 * The interfaces that the Service Provider Application exposes outside of the 
	 * network proximity
	 */
	@Position(1)
