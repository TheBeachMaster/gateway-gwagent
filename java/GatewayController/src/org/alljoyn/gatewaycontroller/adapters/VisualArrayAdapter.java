...
public abstract class VisualArrayAdapter extends ArrayAdapter<VisualItem> {
	...
	/**
	 * Constructor
	 * @param context The context of the activity running the adapter
	 * @param viewItemResId The resource id of the viewed item
	 * @param itemsList The list of the {@link VisualItem}s managed by the adapter
	 * @throws IllegalArgumentException if the received itemsList or context are undefined
	 */
