...
GatewayAppManifest::GatewayAppManifest() : m_ManifestData(""), m_PackageName(""), m_FriendlyName(""),
    m_ExecutableName(""), m_Version(""), m_MinAjSdkVersion("")
{
}

GatewayAppManifest::~GatewayAppManifest()
{
}

const qcc::String& GatewayAppManifest::getFriendlyName() const
{
    return m_FriendlyName;
}

const qcc::String& GatewayAppManifest::getMinAjSdkVersion() const
{
    return m_MinAjSdkVersion;
}

const qcc::String& GatewayAppManifest::getPackageName() const
{
    return m_PackageName;
}

const qcc::String& GatewayAppManifest::getVersion() const
{
    return m_Version;
}

const qcc::String& GatewayAppManifest::getManifestData() const
{
    return m_ManifestData;
}

const GatewayAppManifest::ManifestPermissions& GatewayAppManifest::getExposedServices() const
{
    return m_ExposedServices;
}

const GatewayAppManifest::ManifestPermissions& GatewayAppManifest::getRemotedServices() const
{
    return m_RemotedServices;
}

const std::vector<qcc::String>& GatewayAppManifest::getEnvironmentVariables() const
{
    return m_EnvironmentVariables;
}

const qcc::String& GatewayAppManifest::getExecutableName() const
{
    return m_ExecutableName;
}

const std::vector<qcc::String>& GatewayAppManifest::getAppArguments() const
{
    return m_AppArguments;
}

QStatus GatewayAppManifest::parseManifestFile(qcc::String const& manifestFileName)
{
...
void GatewayAppManifest::parseObjects(xmlNode* currentKey, ManifestPermissions& permissionsMap)
{
    for  (xmlNode* objectKey = currentKey->children; objectKey != NULL; objectKey = objectKey->next) {
        ...
        bool isPrefix = false;
        std::vector<GatewayManifestObject::InterfaceDesc> interfaces;
        ...
        for  (xmlNode* objectPathKey = objectKey->children; objectPathKey != NULL; objectPathKey = objectPathKey->next) {
            ...
            for  (xmlNode* interfaceKey = objectPathKey->children; interfaceKey != NULL; interfaceKey = interfaceKey->next) {
                ...
                GatewayManifestObject::InterfaceDesc interface;
        ...
        GatewayManifestObject object(objectPath, objectFriendly, isPrefix, interfaces);
        permissionsMap.push_back(object);
    }
}

void GatewayAppManifest::parseExecutionInfo(xmlNode* currentKey)
{
