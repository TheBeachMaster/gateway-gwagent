...
/**
 * AppBusObject - BusObject for App
 */
class AppBusObject : public BusObject  {
  public:
     ...
     */
    AppBusObject(BusAttachment* bus, GatewayApp* app, qcc::String const& objectPath, QStatus* status);
  ...
  private:
    ...
    /**
     * The app that contains this busObject
     */
    GatewayApp* m_App;
    ...
    /**
     * Private function to create the Acl Management Interface
     * @param bus - bus used to create the interface
     * @return status - success/failure
     */
    ...
    /**
     * private function to marshal an ObjectDescription of a Manifest
     * @param permissionsMap - map to marshal
     * @param msgArg - msgArg to marshal it into
     * @return status - success/failure
     */
    QStatus marshalObjectDesciptions(const GatewayAppManifest::ManifestPermissions& permissionsMap, MsgArg* msgArg);
