...
class GatewayAppManifest {
  ...
  public:
     ...
     */
    typedef std::vector<GatewayManifestObject> ManifestPermissions;

    /**
     * Constructor for GatewayAppManifest
     */
    GatewayAppManifest();

    /**
     * Destructor for GatewayAppManifest
     */
    virtual ~GatewayAppManifest();
     ...
     */
    const ManifestPermissions& getExposedServices() const;

    /**
     * Get the RemotedServices
     * @return remotedServices
     */
    const ManifestPermissions& getRemotedServices() const;
  ...
  private:
     ...
     */
    ManifestPermissions m_ExposedServices;

    /**
     * RemotedServices of the App
     */
    ManifestPermissions m_RemotedServices;
     ...
     */
    void parseObjects(xmlNode* currentKey, ManifestPermissions& permissionsMap);
