...
#ifndef GatewayCtrlConnectorApp_H
#define GatewayCtrlConnectorApp_H
...
#include <alljoyn/gateway/GatewayCtrlConnectorAppStatus.h>
#include <alljoyn/gateway/GatewayCtrlConnectorAppStatusSignalHandler.h>
...
class ChangedSignalData : public TaskData {
  public:
     ...
     * @return GatewayCtrlConnectorAppStatus
     */
    const GatewayCtrlConnectorAppStatus*getConnectorAppStatus() const { return &m_ConnectorAppStatus; }
  ...
  private:
    GatewayCtrlConnectorAppStatus m_ConnectorAppStatus;
...
class ChangedSignalTask : public AsyncTask {
  public:
     ...
     */
    void setHandler(const GatewayCtrlConnectorAppStatusSignalHandler*handler) { m_Handler = (GatewayCtrlConnectorAppStatusSignalHandler*)handler; }
  ...
  private:
    ...
    GatewayCtrlConnectorAppStatusSignalHandler*m_Handler;
};

class GatewayCtrlConnectorApp : public MessageReceiver {
  ...
  public:
     ...
     * Destructor
     */
    virtual ~GatewayCtrlConnectorApp();
     ...
     * @param connectorCapabilities {@link GatewayCtrlAclRules}
     * @return {@QStatus}
     */
    QStatus retrieveConnectorCapabilities(SessionId sessionId, GatewayCtrlConnectorCapabilities** connectorCapabilities);
     ...
     * @param configurableRules {@link GatewayCtrlAclRules}
     * @return {@QStatus}
     */
    QStatus retrieveApplicableConnectorCapabilities(SessionId sessionId, std::vector<AnnouncementData*> const& announcements, GatewayCtrlAclRules** configurableRules);


    /**
     * Retrieves the state of the application
     * @param sessionId The id of the session established with the gateway
     * @param applicationStatus {@link GatewayCtrlConnectorAppStatus}
     * @return {@QStatus}
     */
    QStatus retrieveStatus(SessionId sessionId, GatewayCtrlConnectorAppStatus** applicationStatus);
     ...
     * @return {@QStatus}
     */
    QStatus setStatusSignalHandler(const GatewayCtrlConnectorAppStatusSignalHandler*handler);
    ...
    QStatus createAcl(SessionId sessionId, const qcc::String& name, GatewayCtrlAclRules* aclRules, GatewayCtrlAclWriteResponse** aclWriteResponse);
     ...
     * @return {@QStatus}
     */
    QStatus retrieveAcls(SessionId sessionId, std::vector <GatewayCtrlAcl*>& acls);
     ...
     * @return {@QStatus}
     */
    static QStatus  extractRemotedApps(const std::vector<GatewayCtrlRuleObjectDescription*>& remotedServices,
  ...
  private:
    ...
    std::vector <GatewayCtrlAcl*> m_Acls;

    GatewayCtrlConnectorCapabilities*m_ConnectorCapabilities;

    GatewayCtrlAclRules*m_ConfigurableRules;
     ...
     */
    static GatewayCtrlRemotedApp* extractRemotedApp(const std::vector<GatewayCtrlRuleObjectDescription*>& remotedServices, const AnnouncementData*ann, QStatus& status);
...
#endif /* defined(GatewayCtrlConnectorApp_H) */
