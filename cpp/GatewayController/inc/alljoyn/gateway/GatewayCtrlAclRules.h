...
#ifndef GatewayCtrlAclRules_H
#define GatewayCtrlAclRules_H
...
class GatewayCtrlAclRules {
  public:
     ...
     * @return {@link QStatus}
     */
    QStatus init(const MsgArg*exposedServicesArrayArg, const MsgArg*remotedAppsArrayArg, const GatewayCtrlConnectorCapabilities& connectorCapabilities, const std::map<qcc::String, qcc::String>& internalMetadata);
     ...
     */
    QStatus init(std::vector<GatewayCtrlRuleObjectDescription*> const& exposedServices, std::vector<GatewayCtrlRemotedApp*> const& remotedApps);

    /**
     * Destructor
     */
    virtual ~GatewayCtrlAclRules();
     ...
     */
    const std::vector<GatewayCtrlRuleObjectDescription*>& getExposedServices();
...
#endif /* defined(GatewayCtrlAclRules_H) */
