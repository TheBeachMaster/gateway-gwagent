...
#ifndef GatewayCtrlRuleObjectDescription_H
#define GatewayCtrlRuleObjectDescription_H
...
class GatewayCtrlRuleInterface {
  public:
     ...
     */
    GatewayCtrlRuleInterface(const qcc::String& name, const qcc::String& friendlyName, bool isSecured);

    /**
     * Copy Constructor
     * @param other Object to copy from
     */
    GatewayCtrlRuleInterface(const GatewayCtrlRuleInterface& other) { m_Name = other.m_Name; m_FriendlyName = other.m_FriendlyName; m_IsSecured = other.m_IsSecured; }

    /**
     * Destructor
     */
    virtual ~GatewayCtrlRuleInterface() { }
     ...
     */
    bool operator<(const GatewayCtrlRuleInterface to) const;
...
class GatewayCtrlRuleObjectPath {
  public:
     ...
     * to the end user.
     */
    GatewayCtrlRuleObjectPath(const qcc::String& objectPath, const qcc::String& friendlyName, bool isPrefix, bool isPrefixAllowed);

    /**
     * Destructor
     */
    virtual ~GatewayCtrlRuleObjectPath();
    ...
    bool operator<(const GatewayCtrlRuleObjectPath& other) const {
...
class GatewayCtrlRuleObjectDescription {
  ...
  public:
     ...
     */
    GatewayCtrlRuleObjectDescription(const GatewayCtrlRuleObjectPath& objectPath, std::set<GatewayCtrlRuleInterface> interfaces);

    /**
     * Constructor
     * @param objectPath AllJoyn object identification
     * @param interfaces Set of the interfaces related to the given object path
     * @param configured  Set TRUE to permit this {@link GatewayCtrlRuleObjectDescription} object path and interfaces
     * to be remoted by the Connector App
     */
    GatewayCtrlRuleObjectDescription(const GatewayCtrlRuleObjectPath& objectPath, std::set<GatewayCtrlRuleInterface> interfaces, bool isConfigured);

    /**
     * Destructor
     */
    virtual ~GatewayCtrlRuleObjectDescription();

    /**
     * The object path supported by the Service Provider Application manifest
     * @return Object path
     */
    GatewayCtrlRuleObjectPath* getObjectPath() const;

    /**
     * The interfaces supported by the Service Provider Application manifest
     * @return Set of the {@link RuleInterface} objects
     */
    const std::set<GatewayCtrlRuleInterface>*getInterfaces() const;
  ...
  private:
     ...
     * The object path supported by the Service Provider Application manifest
     */
    GatewayCtrlRuleObjectPath*m_ObjectPath;

    /**
     * The interfaces supported by the Service Provider Application manifest
     */
    std::set<GatewayCtrlRuleInterface> m_Interfaces;
};
}
}
#endif /* defined(GatewayCtrlRuleObjectDescription_H) */
