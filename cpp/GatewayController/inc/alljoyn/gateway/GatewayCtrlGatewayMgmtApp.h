...
#ifndef GatewayCtrlGatewayMgmtApp_H
#define GatewayCtrlGatewayMgmtApp_H
...
class GatewayCtrlGatewayMgmtApp : public GatewayCtrlAnnouncedApp {
  public:

    /**
     * Constructor
     */
    GatewayCtrlGatewayMgmtApp() : GatewayCtrlAnnouncedApp(), m_SessionHandler(NULL) { }
     ...
     * Destructor
     */
    virtual ~GatewayCtrlGatewayMgmtApp();
     ...
     * @param connectorApps A reference to a vector of {@link GatewayCtrlConnectorApp} objects
     * @return {@link QStatus}
     */
    QStatus retrieveConnectorApps(SessionId sessionId, std::vector<GatewayCtrlConnectorApp*>& connectorApps);
  ...
  private:
    ...
    std::vector<GatewayCtrlConnectorApp*> m_InstalledApps;
...
#endif /* defined(GatewayCtrlGatewayMgmtApp_H) */
