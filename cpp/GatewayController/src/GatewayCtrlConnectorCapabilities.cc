...
QStatus GatewayCtrlConnectorCapabilities::init(const ajn::MsgArg*manifRulesAJ)
{
    QStatus status;
...
GatewayCtrlConnectorCapabilities::~GatewayCtrlConnectorCapabilities()
{

}

const std::vector<GatewayCtrlRuleObjectDescription*>& GatewayCtrlConnectorCapabilities::getExposedServices() const
{
    return m_ExposedServices;
}

const std::vector<GatewayCtrlRuleObjectDescription*>& GatewayCtrlConnectorCapabilities::getRemotedServices() const
{
    return m_RemotedServices;
}


void GatewayCtrlConnectorCapabilities::emptyVectors()
{
...
QStatus GatewayCtrlConnectorCapabilities::release()
{
    emptyVectors();
