...
QStatus GatewayCtrlConnectorAppStatus::init(InstallStatus installStatus, const qcc::String& installDescription, ConnectionStatus connectionStatus, OperationalStatus operationalStatus)
...
QStatus GatewayCtrlConnectorAppStatus::init(const ajn::MsgArg* returnArgs)
{
...
GatewayCtrlConnectorAppStatus::~GatewayCtrlConnectorAppStatus() {
}

InstallStatus GatewayCtrlConnectorAppStatus::getInstallStatus()
{
    return m_InstallStatus;
}

const qcc::String& GatewayCtrlConnectorAppStatus::getInstallDescriptions()
{
    return m_InstallDescription;
}

ConnectionStatus GatewayCtrlConnectorAppStatus::getConnectionStatus()
{
    return m_ConnectionStatus;
}

OperationalStatus GatewayCtrlConnectorAppStatus::getOperationalStatus()
{
